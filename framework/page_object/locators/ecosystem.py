...
class EcosystemLocators(BaseLocator):
    @property
    def head_section(self):
        header = self.translator.get_translation('ecosystem.head_section.header')
        description = self.translator.get_translation('ecosystem.head_section.description')
