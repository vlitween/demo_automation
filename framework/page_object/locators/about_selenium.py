...
class AboutSeleniumLocators(BaseLocator):
    @property
    def head_section(self):
        header = self.translator.get_translation('about_selenium.head_section.header')
        description = self.translator.get_translation('about_selenium.head_section.description')
