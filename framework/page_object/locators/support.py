...
class SupportLocators(BaseLocator):
    @property
    def head_section(self):
        header = self.translator.get_translation('support.head_section.header')
        description = self.translator.get_translation('support.head_section.description')
