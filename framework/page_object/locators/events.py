...
class EventsLocators(BaseLocator):
    @property
    def head_section(self):
        header = self.translator.get_translation('events.head_section.header')
        description = self.translator.get_translation('events.head_section.description')
