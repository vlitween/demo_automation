...
from framework.page_object.locators.downloads import DownloadsLocators
...
class DownloadsPage(BasePage):
    url = f'{variables.MAIN_URL}/downloads/'

    @property
    def locators(self):
        return DownloadsLocators(self.device)
    ...
    def check_page_presence(self, fast_check=False):
        with allure.step('Wait page title'):
            self.actions.wait_page_title(self.translator.get_translation('downloads.page_title'))
