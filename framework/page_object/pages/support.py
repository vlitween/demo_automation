...
from framework.page_object.locators.support import SupportLocators
...
class SupportPage(BasePage):
    url = f'{variables.MAIN_URL}/support/'

    @property
    def locators(self):
        return SupportLocators(self.device)
    ...
    def check_page_presence(self, fast_check=False):
        with allure.step('Wait page title'):
            self.actions.wait_page_title(self.translator.get_translation('support.page_title'))
