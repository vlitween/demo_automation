...
from framework.page_object.locators.blog import BlogLocators
...
class BlogPage(BasePage):
    url = f'{variables.MAIN_URL}/blog/'

    @property
    def locators(self):
        return BlogLocators(self.device)
    ...
    def check_page_presence(self, fast_check=False):
        with allure.step('Wait page title'):
            self.actions.wait_page_title(self.translator.get_translation('blog.page_title'))
