...
from framework.page_object.locators.about_selenium import AboutSeleniumLocators
...
class AboutSeleniumPage(BasePage):
    url = f'{variables.MAIN_URL}/about/'

    @property
    def locators(self):
        return AboutSeleniumLocators(self.device)
    ...
    def check_page_presence(self, fast_check=False):
        with allure.step('Wait page title'):
            self.actions.wait_page_title(self.translator.get_translation('about_selenium.page_title'))
